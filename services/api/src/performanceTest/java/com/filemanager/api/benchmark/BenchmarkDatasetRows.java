...
record FileGrantRow(
        ...
        UUID createdByUserId,
        OffsetDateTime createdAt,
        OffsetDateTime revokedAt) implements CsvWritable {
    @Override
    public String toCsv() {
        return BenchmarkCsvRows.row(id, fileId, granteeUserId, permission, createdByUserId, createdAt, revokedAt);
    }
}

record FolderGrantRow(
        UUID id,
        UUID folderId,
        UUID granteeUserId,
        String permission,
    ...
    @Override
    public String toCsv() {
        return BenchmarkCsvRows.row(id, folderId, granteeUserId, permission, scope, createdByUserId, createdAt, revokedAt);
    }
}

record ProcessingJobRow(
        UUID id,
        UUID fileId,
        String jobType,
        String status,
    ...
    @Override
    public String toCsv() {
        return BenchmarkCsvRows.row(id, fileId, jobType, status, externalJobId, errorMessage, createdAt, updatedAt);
    }
}
