...
public interface ExactDuplicateCandidateRepository extends JpaRepository<FileFingerprint, UUID> {
    @Query("""
            select new com.diogotoporcov.filemanager.api.duplicate.persistence.ExactDuplicateCandidateProjection(
                file.id,
                file.name,
                file.mimeType,
                file.size,
    ...
    @Query("""
            select new com.diogotoporcov.filemanager.api.duplicate.persistence.ExactDuplicateGroupKeyProjection(
    ...
    @Query("""
            select new com.diogotoporcov.filemanager.api.duplicate.persistence.ExactDuplicateGroupFileProjection(
                fingerprint.algorithm,
                fingerprint.hashValue,
                file.id,
                file.name,
