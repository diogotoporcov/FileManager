...
FileManager is a full rearchitecture of [Finder v2](https://github.com/diogotoporcov/Finder2), rebuilt with a Spring-based backend and a modern microservice architecture, with plans to use React with TypeScript for the frontend implementation.
